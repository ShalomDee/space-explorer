  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center my-16">
        <h2 className="text-3xl font-bold mb-4">Perfect for Schools and Education</h2>
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
          NASA Explorer is designed to inspire the next generation of scientists, engineers, and explorers.
        </p>

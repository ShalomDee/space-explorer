...
function FavoritesPage({ userId }) {
  ...
  // Move loadFavorites function definition before useEffect
  ...
  // Fixed: Include userId in dependency array and loadFavorites is safe because it's memoized with useCallback
  useEffect(() => {
    if (userId) { // Only load if userId is provided
      loadFavorites();
    }
  ...
  const viewImageDetails = useCallback((image) => {
    ...
    <div className="max-w-6xl mx-auto">
          ...
          <div key={favorite._id} className="card">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between">
                <button 
                  onClick={() => viewImageDetails(favorite)}
                  className="text-space-light hover:text-space-dark transition-colors"
                >
                  View Details
                </button>
                <button 
                  ...
                  className="text-space-accent hover:text-red-700 transition-colors"
                >
                  Remove
                </button>
              </div>
      ...
      {selectedImage && (
        <div 
          ...
          onClick={closeImageDetails} // Close when clicking backdrop
        >
          <div 
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between gap-4">
                ...
                <button 
                  onClick={() => {
                    handleRemoveFavorite(selectedImage._id);
                    closeImageDetails();
                  }}
